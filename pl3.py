...
def ProcessData(begin=0):
    ...
    print("")
    print("近100期奇偶比：" + str(ch.CalBSaOE(begin, begin + 100, 1, "BS", 0)))
    print("近50期奇偶比：" + str(ch.CalBSaOE(begin, begin + 50, 1, "BS", 0)))
    print("近30期奇偶比：" + str(ch.CalBSaOE(begin, begin + 30, 1, "BS", 0)))
    print("近10期奇偶比：" + str(ch.CalBSaOE(begin, begin + 10, 1, "BS", 0)))
    print("")
